(function () {
  const state = {
    lang: localStorage.getItem("kxert-baby-lang") || "zh"
  };
  ...
  function renderProductDetail() {
    ...
    document.title = `${productName(product)} | Kxert`;
      ...
      <section class="detail-hero">
        <div class="detail-copy">
          ...
          <div class="detail-actions">
            <strong>${product.price}</strong>
            <a class="primary-btn" href="mailto:hello@kxert-baby.example">${t("detail.contact")}</a>
          </div>
  ...
  function applyLanguage(lang) {
    state.lang = lang;
    localStorage.setItem("kxert-baby-lang", lang);
